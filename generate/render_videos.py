...
# Video options
parser.add_argument(
    '--num_frames', default=100, type=int,
...
def render_segs(blender_objects, obj_id):
  """
  ...
  seg_name = base_name[:-4] + '_seg_{obj_id}.avi'.format(obj_id=obj_id)
